...
export default defineConfig({
  ...
  plugins: [
    ...
    plg_svg2png(
      [
        { src: PATH.brand + "/goose-search-wordmark.svg", dest: PATH.dist + "/img/favicon.png" },
        { src: PATH.brand + "/goose-search.svg", dest: PATH.dist + "/img/goose-search.png" },
      ],
    ),
    ...
    plg_svg2svg(
      [
        { src: PATH.brand + "/goose-search.svg", dest: PATH.dist + "/img/goose-search.svg" },
    ...
    // -- favicon
    plg_svg2svg(
      [ { src: PATH.brand + "/goose-search-wordmark.svg", dest: PATH.dist + "/img/favicon.svg" } ],
